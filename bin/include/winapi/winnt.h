...
typedef struct DECLSPEC_ALIGN(4) _LUID_AND_ATTRIBUTES {
  LUID Luid;
  DWORD Attributes;
...
typedef struct DECLSPEC_ALIGN(2) _IMAGE_DOS_HEADER {
  WORD e_magic;
  WORD e_cblp;
  WORD e_cp;
  WORD e_crlc;
...
typedef struct DECLSPEC_ALIGN(2) _IMAGE_OS2_HEADER {
  WORD ne_magic;
  CHAR ne_ver;
  CHAR ne_rev;
  WORD ne_enttab;
...
typedef struct DECLSPEC_ALIGN(2) _IMAGE_VXD_HEADER {
  WORD e32_magic;
  BYTE e32_border;
  BYTE e32_worder;
  DWORD e32_level;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_FILE_HEADER {
  WORD Machine;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_DATA_DIRECTORY {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_OPTIONAL_HEADER {
  WORD Magic;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_ROM_OPTIONAL_HEADER {
  WORD Magic;
  BYTE MajorLinkerVersion;
  BYTE MinorLinkerVersion;
  DWORD SizeOfCode;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_OPTIONAL_HEADER64 {
  WORD Magic;
  BYTE MajorLinkerVersion;
  BYTE MinorLinkerVersion;
  DWORD SizeOfCode;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_NT_HEADERS64 {
  DWORD Signature;
  IMAGE_FILE_HEADER FileHeader;
  IMAGE_OPTIONAL_HEADER64 OptionalHeader;
} IMAGE_NT_HEADERS64,*PIMAGE_NT_HEADERS64;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_NT_HEADERS {
  DWORD Signature;
  IMAGE_FILE_HEADER FileHeader;
  IMAGE_OPTIONAL_HEADER32 OptionalHeader;
} IMAGE_NT_HEADERS32,*PIMAGE_NT_HEADERS32;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_ROM_HEADERS {
  IMAGE_FILE_HEADER FileHeader;
...
typedef struct DECLSPEC_ALIGN(4) ANON_OBJECT_HEADER {
  WORD Sig1;
  WORD Sig2;
  WORD Version;
  WORD Machine;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_SECTION_HEADER {
...
typedef struct DECLSPEC_ALIGN(2) _IMAGE_SYMBOL {
  union {
	  BYTE ShortName[8];
	  struct {
	    DWORD Short;
...
typedef struct DECLSPEC_ALIGN(2) IMAGE_AUX_SYMBOL_TOKEN_DEF {
  BYTE bAuxType;
  BYTE bReserved;
...
typedef struct DECLSPEC_ALIGN(2) _IMAGE_RELOCATION {
  union {
	  DWORD VirtualAddress;
	  DWORD RelocCount;
  };
...
typedef struct DECLSPEC_ALIGN(2) _IMAGE_LINENUMBER {
  union {
	  DWORD SymbolTableIndex;
	  DWORD VirtualAddress;
  } Type;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_BASE_RELOCATION {
  DWORD VirtualAddress;
  DWORD SizeOfBlock;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_ARCHIVE_MEMBER_HEADER {
  BYTE Name[16];
  BYTE Date[12];
  BYTE UserID[6];
  BYTE GroupID[6];
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_EXPORT_DIRECTORY {
  DWORD Characteristics;
  DWORD TimeDateStamp;
  WORD MajorVersion;
  WORD MinorVersion;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_IMPORT_BY_NAME {
  WORD Hint;
  BYTE Name[1];
} IMAGE_IMPORT_BY_NAME,*PIMAGE_IMPORT_BY_NAME;

typedef struct DECLSPEC_ALIGN(8) _IMAGE_THUNK_DATA64 {
  union {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_THUNK_DATA32 {
  union {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_TLS_DIRECTORY64 {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_TLS_DIRECTORY32 {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_IMPORT_DESCRIPTOR {
  union {
	  DWORD Characteristics;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_BOUND_IMPORT_DESCRIPTOR {
  DWORD TimeDateStamp;
  WORD OffsetModuleName;
  WORD NumberOfModuleForwarderRefs;
} IMAGE_BOUND_IMPORT_DESCRIPTOR,*PIMAGE_BOUND_IMPORT_DESCRIPTOR;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_BOUND_FORWARDER_REF {
  DWORD TimeDateStamp;
  WORD OffsetModuleName;
  WORD Reserved;
} IMAGE_BOUND_FORWARDER_REF,*PIMAGE_BOUND_FORWARDER_REF;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_RESOURCE_DIRECTORY {
  DWORD Characteristics;
  DWORD TimeDateStamp;
  WORD MajorVersion;
  WORD MinorVersion;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_RESOURCE_DIRECTORY_ENTRY {
  union {
	  struct {
	    DWORD NameOffset:31;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_RESOURCE_DIRECTORY_STRING {
  WORD Length;
  CHAR NameString[1];
} IMAGE_RESOURCE_DIRECTORY_STRING,*PIMAGE_RESOURCE_DIRECTORY_STRING;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_RESOURCE_DIR_STRING_U {
  WORD Length;
  WCHAR NameString[1];
} IMAGE_RESOURCE_DIR_STRING_U,*PIMAGE_RESOURCE_DIR_STRING_U;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_RESOURCE_DATA_ENTRY {
  DWORD OffsetToData;
  DWORD Size;
  DWORD CodePage;
  DWORD Reserved;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_CE_RUNTIME_FUNCTION_ENTRY {
  DWORD FuncStart;
  DWORD PrologLen : 8;
  DWORD FuncLen : 22;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_ALPHA64_RUNTIME_FUNCTION_ENTRY {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_ALPHA_RUNTIME_FUNCTION_ENTRY {
  DWORD BeginAddress;
  DWORD EndAddress;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_RUNTIME_FUNCTION_ENTRY {
  DWORD BeginAddress;
  DWORD EndAddress;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_DEBUG_DIRECTORY {
  DWORD Characteristics;
  DWORD TimeDateStamp;
  WORD MajorVersion;
  WORD MinorVersion;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_COFF_SYMBOLS_HEADER {
  DWORD NumberOfSymbols;
...
typedef struct DECLSPEC_ALIGN(4) _FPO_DATA {
  DWORD ulOffStart;
  DWORD cbProcSize;
  DWORD cdwLocals;
  WORD cdwParams;
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_DEBUG_MISC {
  DWORD DataType;
  DWORD Length;
  BOOLEAN Unicode;
  BYTE Reserved[3];
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_FUNCTION_ENTRY {
  DWORD StartingAddress;
  DWORD EndingAddress;
  DWORD EndOfPrologue;
} IMAGE_FUNCTION_ENTRY,*PIMAGE_FUNCTION_ENTRY;

typedef struct DECLSPEC_ALIGN(4) _IMAGE_FUNCTION_ENTRY64 {
...
typedef struct DECLSPEC_ALIGN(4) _IMAGE_SEPARATE_DEBUG_HEADER {
  WORD Signature;
  WORD Flags;
  WORD Machine;
  WORD Characteristics;
...
typedef struct DECLSPEC_ALIGN(4) _NON_PAGED_DEBUG_INFO {
  WORD Signature;
  WORD Flags;
  DWORD Size;
  WORD Machine;
...
typedef struct DECLSPEC_ALIGN(4) _ImageArchitectureHeader {
...
typedef struct DECLSPEC_ALIGN(4) _ImageArchitectureEntry {
  DWORD FixupInstRVA;
  DWORD NewInst;
