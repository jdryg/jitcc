...
#define BI_PNG 5L
  ...
  typedef struct __attribute__((aligned(2))) tagBITMAPFILEHEADER {
    WORD bfType;
    DWORD bfSize;
    WORD bfReserved1;
    WORD bfReserved2;
...
#define TCI_SRCLOCALE 0x1000
  ...
  typedef struct __attribute__((aligned(2))) tagMETAHEADER {
    WORD mtType;
    WORD mtHeaderSize;
    WORD mtVersion;
    DWORD mtSize;
...
#define NTM_DSIG 0x00200000
  ...
  typedef struct __attribute__((aligned(4))) tagNEWTEXTMETRICA {
    LONG tmHeight;
    LONG tmAscent;
    LONG tmDescent;
    LONG tmInternalLeading;
  ...
  typedef struct __attribute__((aligned(4))) tagNEWTEXTMETRICW {
    LONG tmHeight;
    LONG tmAscent;
    LONG tmDescent;
    LONG tmInternalLeading;
